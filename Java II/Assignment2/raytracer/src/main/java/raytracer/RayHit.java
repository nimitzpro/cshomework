...
public class RayHit {
	 ...
	 * @param shape takes shape class
	 * @param normal takes vector class
	 * @param t double number
	 * @param entering bool
	 */
	 ...
	 * @param shape takes shape class
	 * @param normal takes vector class
	 * @param intersection takes point class
	 * @param entering bool
	 */
	...
	public Ray getTransmissionRay() {
		...
		double cosi = v.dot(n);
		double nint;
		if(incoming) nint = 1.0 / shape.finish.indexOfReflection;
		else nint = shape.finish.indexOfReflection;
